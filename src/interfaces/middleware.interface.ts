import type { Context as ElysiaContext, Handler as ElysiaHandler } from 'elysia';
...
export function isClassMiddleware(middleware: MiddlewareType): middleware is Type<ElysiaNestMiddleware> {
